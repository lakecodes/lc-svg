(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/common'), require('@angular/platform-browser'), require('@angular/http'), require('rxjs/Observable'), require('xml2js'), require('rxjs/add/operator/map'), require('rxjs/add/operator/do'), require('rxjs/add/operator/catch')) :
	typeof define === 'function' && define.amd ? define(['exports', '@angular/core', '@angular/common', '@angular/platform-browser', '@angular/http', 'rxjs/Observable', 'xml2js', 'rxjs/add/operator/map', 'rxjs/add/operator/do', 'rxjs/add/operator/catch'], factory) :
	(factory((global['lc-svg'] = {}),global.ng.core,global.ng.common,global.ng.platformBrowser,global.ng.http,global.Rx,global['^0']['4']['19']));
}(this, (function (exports,core,common,platformBrowser,http,Observable,xml2js) { 'use strict';
...
var LcSvgComponent = (function () {
    ...
    function LcSvgComponent(_svgService) {
        ...
        this.svgclick = new core.EventEmitter();
...
var LcSvgGroupComponent = (function () {
    function LcSvgGroupComponent() {
        this.gExport = '';
        this.attr = '';
        this.shapeClick = new core.EventEmitter();
        this.shapeMouse = new core.EventEmitter();
    }
    /**
     * @param {?} e
     * @return {?}
...
LcSvgGroupComponent.propDecorators = {
    'g': [{ type: core.Input },],
    'config': [{ type: core.Input },],
    'clickenable': [{ type: core.Input },],
    'mouseenable': [{ type: core.Input },],
    'cssenable': [{ type: core.Input },],
    'shapeClick': [{ type: core.Output },],
    'shapeMouse': [{ type: core.Output },],
};
...
exports.LcSvgModule = LcSvgModule;
exports.ɵa = LcSvgComponent;
exports.ɵc = ReturnKeysPipe;
exports.ɵd = LcSvgGroupComponent;
exports.ɵb = LcSvgService;

Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=lc-svg.umd.js.map
